        ...
        <Button
          ...
          onClick={async () => {            
            ...
            await contract.methods
              .buy_(new BigNumber(value).times(new BigNumber(10).pow(18)).toString()).send({from: account})

            toastSuccess("Success","Thank You for your support of IMME project and please refresh your browser")
